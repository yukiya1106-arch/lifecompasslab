...
function closeAsset(){if(overlay)overlay.style.display='none';suppressed=true}
...
window.addEventListener('message',event=>{if(event.data==='lc-close-asset-v9')closeAsset()});
