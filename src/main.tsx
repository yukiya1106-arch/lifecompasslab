  ...
  return (
    ...
    >
      <div className="grid gap-5">
        ...
        <PolicyBlock title="石井 悠己也">
          <div className="space-y-1 text-sm font-semibold leading-7 text-blue">
            <p>ファイナンシャルプランナー</p>
            <p>LIFE COMPASS LAB 運営</p>
            <p>FP Office株式会社 所属</p>
          </div>
          <p>住宅購入、家計、資産形成、保険、退職後資金など、お金に関する相談に携わっています。</p>
          <p>
            これまで多くの相談を受けるなかで感じてきたのは、情報や制度を知ることと、自分に合った選択ができることは、必ずしも同じではないということです。
          </p>
          <p>
            数字上では合理的な選択でも、その人の価値観や家族の希望、これからの暮らし方まで考えると、答えがひとつに決まらないこともあります。
          </p>
          <p>一方で、お金の制度や計算は複雑です。</p>
          <p>住宅ローン、教育費、資産運用、保険、退職金、年金。</p>
          <p>
            それぞれを個別に調べるだけでも大変で、全体を整理しようとすると、考える前に疲れてしまうことも少なくありません。
          </p>
          <p>LIFE COMPASS LABは、そうした複雑さや迷いを、ツールや仕組みによって整理するために立ち上げました。</p>
          <p>AIやデジタル技術を使うこと自体が目的ではありません。</p>
          <p>
            相談現場で実際に感じてきた課題を、入力項目、計算ロジック、画面設計、言葉の伝え方に落とし込み、自分で考え、納得して選ぶための判断材料をつくることを大切にしています。
          </p>
          <p>ツールだけで、すべての答えが出るとは考えていません。</p>
          <p>数字を見えるようにすることで、初めて気づけることがあります。</p>
          <p>
            そして、その数字をどう受け止め、どの道を選ぶかは、その人自身の暮らしや価値観によって変わります。
          </p>
          <p>人生は、正解だけでは決められない。</p>
          <p>
            LIFE COMPASS LABは、人生の選択を少し整理し、自分なりの答えを見つけるための道しるべをつくる場所です。
          </p>

          <div className="pt-4">
            <h3 className="mb-3 text-sm font-bold tracking-[0.16em] text-navy">主な相談分野</h3>
            <div className="flex flex-wrap gap-2">
              {["住宅購入", "ライフプラン", "家計", "資産形成", "保険", "退職金", "年金・老後資金"].map((field) => (
                <span key={field} className="rounded-full bg-lightBlue px-3 py-1 text-sm font-semibold text-navy">
                  {field}
                </span>
              ))}
            </div>
          ...
          <div className="border-t border-blue/15 pt-4">
            <h3 className="mb-2 text-sm font-bold tracking-[0.16em] text-navy">現在の所属</h3>
            <p>FP Office株式会社に所属し、ファイナンシャルプランナーとして相談業務に従事しています。</p>
          </div>

          <p className="border-t border-blue/15 pt-4 text-sm leading-7 text-sub">
            LIFE COMPASS LABは、石井悠己也が個人で運営する研究・情報発信プロジェクトです。
          </p>
        </PolicyBlock>

        <PolicyBlock title="自分の場合について、もう少し詳しく整理したい方へ">
          <p>
            ツールについてのご質問や改善のご提案、ご自身の場合についてもう少し詳しく整理したい方からのお問い合わせを受け付けています。内容に応じて、適切な方法をご案内します。
          </p>
          <div className="mt-5">
            <Button href="#/contact" variant="secondary">
              相談・お問い合わせ
